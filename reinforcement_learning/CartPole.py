...
class DQNSolver:
    def __init__(self, observation_space, action_space):
        ...
        self.model.compile(loss="mse", optimizer=tf.keras.optimizers.RMSprop(lr=LEARNING_RATE))
    ...
    def experience_replay(self):
        ...
        for state, action, reward, state_next, terminal in batch:
            q_update = reward
            # If this isn't the final batch, apply your reward function with your discount value
            if not terminal:
